...
| 카테고리 | 수량 | 포함 |
|---------|------|------|
| EQUIPMENT  | wpn_, arm_, tool_ | 20종 | 도구 11 + 무기 5 + 방어구 4 |
| CONSUMABLE | con_              | 11종 | 붕대, 약초류, 식량류, 술, 연고 |
| MATERIAL   | mat_              | 14종 | 원자재 8 + 가공부산물 6 |
| MISC       | misc_, fac_, info_| 12종 | 용기 5 + 제작도구 4 + 정보 3 |
| 파괴결과물  | item_             | 3종  | 재, 부러진 나무, 썩은 잔해 |
| **합계**   |                   | **60종** | |

### 12.2 확장 계획

- **Phase 2 완료 시**: ~100종 (NPC 직업별 전용 아이템 추가)
- **Phase 3 목표**: ~500종 (10배 증량, 바이옴별/던전별 고유 아이템)
